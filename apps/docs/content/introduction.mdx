...
To use the custom color palette of our documentation simply copy/paste the colors section from the [github repo](https://github.com/rewindui/rewindui/blob/main/apps/docs/tailwind.config.ts) to your `tailwind.config.ts` file. The palette has been generated using [tints.dev](https://www.tints.dev/).
...
# Customization
---
All Almond-UI components are highly customizable. This means that you can easily change the default styles of a component by overriding the corresponding Tailwind CSS classes. You can read more about style customization on the [theming](https://rewind-ui.dev/theming) page.
