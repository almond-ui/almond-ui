...
```tsx
import { Selector } from '@almond-ui/core';
```
...
<View>
  <SelectorShowcase showcase="icons" />
</View>
...
# Accessibility
---
The `Selector` component adheres to the [WAI-ARIA Radio Group Pattern](https://www.w3.org/WAI/ARIA/apg/patterns/radio/).
