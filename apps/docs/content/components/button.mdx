...
<View>
  <Button variant="link" as="a" href="https://www.google.com"
          target="_blank">Google</Button>
</View>
...
<View>
  <Button
    className="text-white bg-pink-500 focus:bg-pink-600 hover:bg-pink-600 active:bg-pink-600/90 focus:ring-pink-300">I
    am pink</Button>
</View>
