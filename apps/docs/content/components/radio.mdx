...
```tsx
import { Radio, RadioGroup } from '@almond-ui/core';
```
...
<View>
  <Radio label="Click me!" description={<span
    className="text-purple-500 bg-purple-50 p-1 rounded">This is a purple description</span>} />
</View>
