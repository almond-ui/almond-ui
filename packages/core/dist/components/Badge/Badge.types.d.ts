...
export type BadgeColor = 'white' | 'blue' | 'red' | 'green' | 'yellow' | 'purple' | 'gray' | 'dark' | 'black';
export type BadgeRadius = 'none' | 'sm' | 'base' | 'md' | 'lg' | 'full';
export type BadgeShadow = 'none' | 'sm' | 'base' | 'md' | 'lg' | 'xl';
export type BadgeShadowColor = 'none' | 'white' | 'blue' | 'red' | 'green' | 'yellow' | 'purple' | 'gray' | 'dark' | 'black';
