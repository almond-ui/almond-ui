...
export type ButtonColor = 'white' | 'blue' | 'red' | 'green' | 'yellow' | 'purple' | 'gray' | 'dark' | 'black';
export type ButtonRadius = 'none' | 'sm' | 'base' | 'md' | 'lg' | 'full';
export type ButtonShadow = 'none' | 'sm' | 'base' | 'md' | 'lg' | 'xl';
export type ButtonShadowColor = 'none' | 'white' | 'blue' | 'red' | 'green' | 'yellow' | 'purple' | 'gray' | 'dark' | 'black';
export type ButtonSize = 'xs' | 'sm' | 'md' | 'lg';
export type ButtonTone = 'solid' | 'light' | 'outline' | 'transparent';
export type ButtonVariant = 'primary' | 'secondary' | 'tertiary' | 'link' | 'danger' | 'success' | 'warning' | 'info';
...
type PolymorphicButtonComponent = <C extends ElementType = 'button'>(props: PolymorphicButtonProps<C>) => ReactElement | null;
