...
export type TheadComponent = ForwardRefExoticComponent<PropsWithoutRef<TheadProps> & RefAttributes<HTMLTableSectionElement>> & {
    displayName?: string;
};
//# sourceMappingURL=Thead.types.d.ts.map