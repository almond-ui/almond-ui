...
export type TbodyComponent = ForwardRefExoticComponent<PropsWithoutRef<TbodyProps> & RefAttributes<HTMLTableSectionElement>> & {
    displayName?: string;
};
//# sourceMappingURL=Tbody.types.d.ts.map