...
export type TfootComponent = ForwardRefExoticComponent<PropsWithoutRef<TfootProps> & RefAttributes<HTMLTableSectionElement>> & {
    displayName?: string;
};
//# sourceMappingURL=Tfoot.types.d.ts.map