...
export type AvatarColor = 'white' | 'blue' | 'red' | 'green' | 'yellow' | 'purple' | 'gray' | 'dark' | 'black';
export type AvatarRadius = 'none' | 'sm' | 'base' | 'md' | 'lg' | 'full';
export type AvatarShadow = 'none' | 'sm' | 'base' | 'md' | 'lg' | 'xl';
export type AvatarShadowColor = 'none' | 'white' | 'blue' | 'red' | 'green' | 'yellow' | 'purple' | 'gray' | 'dark' | 'black';
