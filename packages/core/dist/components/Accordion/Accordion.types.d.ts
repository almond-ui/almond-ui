...
export type AccordionActiveColor = 'white' | 'blue' | 'red' | 'green' | 'yellow' | 'purple' | 'gray' | 'dark' | 'black';
...
export type AccordionComponent = ForwardRefExoticComponent<PropsWithoutRef<AccordionProps> & RefAttributes<HTMLDivElement>> & {
    displayName?: string;
};
