import { ComponentPropsWithRef, ForwardedRef, ForwardRefExoticComponent, PropsWithoutRef, RefAttributes } from 'react';
...
export type ImageComponent = ForwardRefExoticComponent<PropsWithoutRef<ImageProps> & RefAttributes<HTMLDivElement>> & {
    displayName?: string;
};
