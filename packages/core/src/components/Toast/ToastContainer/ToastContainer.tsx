...
import { Ref, forwardRef, useEffect, useMemo, useReducer } from 'react';
...
import {
	toastActionEnum,
	toastReducer,
} from '@components/Toast/ToastContainer/toast.reducer';
	...
	useEffect(() => {
		...
		return () => {
			...
			document.removeEventListener(
				'toasts:update',
				updateEvent as EventListener
			);
			document.removeEventListener(
				'toasts:remove',
				removeEvent as EventListener
			);
